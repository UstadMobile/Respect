...
Each school can specify its own xAPI LRS endpoint. It may also implement some 
RESPECT extension endpoints (e.g. to handle sign-up via invitations etc). A school is represented by 
a json file e.g.
