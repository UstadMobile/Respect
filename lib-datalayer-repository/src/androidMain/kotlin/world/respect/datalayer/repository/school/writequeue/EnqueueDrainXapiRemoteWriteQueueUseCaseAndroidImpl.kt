...
class EnqueueDrainXapiRemoteWriteQueueUseCaseAndroidImpl(
    private val context: Context,
    private val scopeId: String,
    private val scopeClass: KClass<*>,
): EnqueueDrainXapiRemoteWriteQueueUseCase {

    override suspend fun invoke() {
        WorkManager.getInstance(context).enqueueUniqueWork(
            uniqueWorkName = "$UNIQUE_NAME_PREFIX-$scopeId",
            existingWorkPolicy = ExistingWorkPolicy.KEEP,
            request = OneTimeWorkRequestBuilder<DrainXapiRemoteWriteQueueWorker>()
    ...
    companion object {
        ...
        const val UNIQUE_NAME_PREFIX = "drainxapiremotewrite"
