...
import world.respect.shared.generated.resources.select_curriculum_unit
...
fun AssignmentEditScreen(
    ...
    AssignmentEditScreen(
        ...
        onClickAddFromCurriculum = viewModel::onClickAddFromCurriculum,
    )
}
