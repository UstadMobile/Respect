package world.respect.shared.viewmodel.manageuser.selectaccount
...
class SelectAccountViewModel(
    ...
    private val route: SelectAccount = savedStateHandle.toRoute()
    ...
    init {
        _appUiState.update {
            it.copy(
                title = Res.string.select_account.asUiText(),
